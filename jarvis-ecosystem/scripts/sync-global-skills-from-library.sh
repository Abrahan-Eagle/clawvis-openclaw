#!/usr/bin/env bash
# Sync global skills from jarvis-skills-library into agents/jarvis/skills/
# Usage:
#   JARVIS_SKILLS_LIBRARY=/var/www/html/proyectos/AIPP/jarvis-skills-library \
#     ./scripts/sync-global-skills-from-library.sh
#
# See: docs/COHERENCIA_RUNTIME_REPO.md, jarvis-skills-library/docs/CLAWVIS_INTEGRATION.md
...
DEST_BASE="$JARVIS_ECOSYSTEM/agents/jarvis/skills"

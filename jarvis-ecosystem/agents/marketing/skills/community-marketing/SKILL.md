...
description: "Construye y activa comunidades online para crecimiento y lealtad. EN: community marketing, community-led"
metadata:
  version: "1.0.0"
...
Construye y activa comunidades online para crecimiento y lealtad.

### Cuándo usarla (disparadores)

- **ES:** `Discord`, `Slack community`, `ambassadors`
- **EN:** `community marketing`, `community-led`

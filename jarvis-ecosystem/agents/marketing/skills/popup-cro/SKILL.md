---
name: popup-cro
description: "Popups, modales y overlays orientados a captura o siguiente paso. EN: popup, modal"
metadata:
  version: "1.1.0"
...
Popups, modales y overlays orientados a captura o siguiente paso.

### Cuándo usarla (disparadores)

- **ES:** `popup`, `modal`, `overlay`
- **EN:** `popup`, `modal`
...
### Marco de trabajo (CRO de popups/modales)

**Objetivo:** overlays que convierten sin romper UX.

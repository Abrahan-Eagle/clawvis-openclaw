...
description: "Define y audita medición: eventos, props, embudos y calidad de datos. EN: analytics tracking, events"
metadata:
  version: "1.1.0"
...
Define y audita medición: eventos, props, embudos y calidad de datos.

### Cuándo usarla (disparadores)

- **ES:** `GA4`, `eventos`, `data layer`
- **EN:** `analytics tracking`, `events`

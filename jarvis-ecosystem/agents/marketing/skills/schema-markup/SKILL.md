---
name: schema-markup
description: "Schema.org y datos estructurados para rich results. EN: schema markup, structured data"
metadata:
  version: "1.1.0"
...
Schema.org y datos estructurados para rich results.

### Cuándo usarla (disparadores)

- **ES:** `schema.org`, `FAQ schema`, `rich snippets`
- **EN:** `schema markup`, `structured data`
...
### Marco de trabajo (Datos estructurados / Schema.org)

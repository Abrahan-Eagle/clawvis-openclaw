...
description: "Pricing, packaging y monetización alineados a valor percibido. EN: pricing strategy, packaging"
metadata:
  version: "1.1.0"
...
Pricing, packaging y monetización alineados a valor percibido.

### Cuándo usarla (disparadores)

- **ES:** `precios`, `packaging`, `descuentos`
- **EN:** `pricing strategy`, `packaging`
...
### Marco de trabajo (Pricing y packaging)
...
- [`paywall-upgrade-cro`](../paywall-upgrade-cro/SKILL.md)

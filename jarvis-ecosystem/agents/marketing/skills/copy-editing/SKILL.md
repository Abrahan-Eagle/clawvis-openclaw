---
name: copy-editing
description: "Edita y pulimenta copy existente con foco en claridad y conversión. EN: copy editing, rewrite"
metadata:
  version: "1.3.0"
...
Edita y pulimenta copy existente con foco en claridad y conversión.

### Cuándo usarla (disparadores)

- **ES:** `pulir texto`, `editar copy`, `claridad`
- **EN:** `copy editing`, `rewrite`
...
### Marco de trabajo (edición de copy)

---
name: onboarding-cro
description: "Optimiza onboarding post-signup: primeros pasos, checklist y habit loops. EN: activation, onboarding, aha moment"
metadata:
  version: "1.1.0"
...
Optimiza onboarding post-signup: primeros pasos, checklist y habit loops.

### Cuándo usarla (disparadores)

- **ES:** `activación`, `primer uso`, `setup wizard`
- **EN:** `activation`, `onboarding`, `aha moment`
...
### Marco de trabajo (CRO de onboarding)

**Objetivo:** activación post-signup y time-to-value.
...
- [`signup-flow-cro`](../signup-flow-cro/SKILL.md)

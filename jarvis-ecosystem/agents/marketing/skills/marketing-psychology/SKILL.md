...
description: "Principios psicológicos y modelos mentales aplicados a marketing. EN: marketing psychology, behavioral"
metadata:
  version: "1.1.0"
...
Principios psicológicos y modelos mentales aplicados a marketing.

### Cuándo usarla (disparadores)

- **ES:** `sesgos`, `priming`, `urgencia ética`
- **EN:** `marketing psychology`, `behavioral`
...
### Marco de trabajo (Psicología de marketing)

---
name: copywriting
description: "Escribe copy persuasivo para páginas (hero, landing, pricing, features). EN: copywriting, landing page copy"
metadata:
  version: "1.1.0"
...
Escribe copy persuasivo para páginas (hero, landing, pricing, features).

### Cuándo usarla (disparadores)

- **ES:** `landing copy`, `hero`, `pricing copy`
- **EN:** `copywriting`, `landing page copy`
...
Variante corta **ops**: [`copywriting-ops`](../../../jarvis/skills/copywriting-ops/SKILL.md). Usa **esta skill completa** con dossier/brief formal.

## Frameworks / metodología

### Marco de trabajo (copywriting / mensajes)
...
[copywriting-ops](../../../jarvis/skills/copywriting-ops/SKILL.md) para iteraciones sin dossier completo.
...
- [`copy-editing`](../copy-editing/SKILL.md)

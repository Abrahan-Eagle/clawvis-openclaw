---
name: aso-audit
description: "Audita y optimiza fichas de App Store / Google Play. EN: ASO, app store"
metadata:
  version: "1.0.0"
...
Audita y optimiza fichas de App Store / Google Play.

### Cuándo usarla (disparadores)

- **ES:** `ASO`, `ficha app`, `keywords móvil`
- **EN:** `ASO`, `app store`
...
### Marco de trabajo (ASO (App Store / Google Play))

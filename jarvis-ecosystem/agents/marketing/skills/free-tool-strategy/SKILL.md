...
description: "Evalúa/diseña free tools para marketing (lead gen, SEO, shares). EN: free tool, micro-product"
metadata:
  version: "1.1.0"
...
Evalúa/diseña free tools para marketing (lead gen, SEO, shares).

### Cuándo usarla (disparadores)

- **ES:** `free tool`, `calculadora`, `widget`
- **EN:** `free tool`, `micro-product`

...
description: "Define pilares temáticos, calendario y foco de negocio. EN: content strategy, editorial"
metadata:
  version: "1.1.0"
...
Define pilares temáticos, calendario y foco de negocio.

### Cuándo usarla (disparadores)

- **ES:** `editorial`, `pilares SEO`, `thought leadership`
- **EN:** `content strategy`, `editorial`
...
### Marco de trabajo (Estrategia de contenidos)

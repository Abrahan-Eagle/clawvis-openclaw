...
description: "Jerarquía de URLs, clusters temáticos y enlazado interno. EN: site architecture, internal linking"
metadata:
  version: "1.1.0"
...
Jerarquía de URLs, clusters temáticos y enlazado interno.

### Cuándo usarla (disparadores)

- **ES:** `estructura web`, `silos`, `internal linking`
- **EN:** `site architecture`, `internal linking`
...
### Marco de trabajo (Arquitectura de información y enlazado interno)

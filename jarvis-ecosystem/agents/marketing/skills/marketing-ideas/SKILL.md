...
description: "Lluvia de ideas y tácticas para SaaS/software. EN: marketing ideas, growth tactics"
metadata:
  version: "1.1.0"
...
Lluvia de ideas y tácticas para SaaS/software.

### Cuándo usarla (disparadores)

- **ES:** `ideas de marketing`, `tácticas`, `growth ideas`
- **EN:** `marketing ideas`, `growth tactics`
...
Workflow **ops** relacionado: [`brainstorming-ops`](../../../jarvis/skills/brainstorming-ops/SKILL.md) (nombre distinto en Jarvis).
...
[brainstorming-ops](../../../jarvis/skills/brainstorming-ops/SKILL.md) — nombre distinto; úsala para sesiones cortas en chat.
...
- [`launch-strategy`](../launch-strategy/SKILL.md)

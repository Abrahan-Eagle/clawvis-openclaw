...
For partner sales enablement, see the [tools registry](../../../../docs/upstream-marketingskills/tools/REGISTRY.md):

| Tool | What It Does | Guide |
|------|-------------|-------|
| **Introw** | Partner engagement tracking, deal registration, mutual action plans | [introw.md](../../../../docs/upstream-marketingskills/tools/integrations/introw.md) |

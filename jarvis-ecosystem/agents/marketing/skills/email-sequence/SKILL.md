---
name: email-sequence
description: "Secuencias drip, lifecycle y automatizaciones de email. EN: email sequence, drip"
metadata:
  version: "1.1.0"
...
Secuencias drip, lifecycle y automatizaciones de email.

### Cuándo usarla (disparadores)

- **ES:** `drip`, `lifecycle email`, `nutrición`
- **EN:** `email sequence`, `drip`
...
### Marco de trabajo (secuencias de email)

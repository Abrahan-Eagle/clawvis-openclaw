...
description: "Diseño y optimización de referidos / afiliados / word-of-mouth. EN: referral program, affiliate"
metadata:
  version: "1.1.0"
...
Diseño y optimización de referidos / afiliados / word-of-mouth.

### Cuándo usarla (disparadores)

- **ES:** `referidos`, `afiliados`, `viral loop`
- **EN:** `referral program`, `affiliate`

---
name: ad-creative
description: "Itera creatividades publicitarias (titulares, textos, bundles creativos). EN: ad creative, ads copy"
metadata:
  version: "1.1.0"
...
Itera creatividades publicitarias (titulares, textos, bundles creativos).

### Cuándo usarla (disparadores)

- **ES:** `creatividades`, `variantes ads`, `UGC brief`
- **EN:** `ad creative`, `ads copy`

...
description: "Paywalls, upgrades, upsells y feature gates in-app. EN: paywall, upgrade, upsell"
metadata:
  version: "1.1.0"
...
Paywalls, upgrades, upsells y feature gates in-app.

### Cuándo usarla (disparadores)

- **ES:** `paywall`, `upgrade`, `upsell`, `pricing in-app`
- **EN:** `paywall`, `upgrade`, `upsell`
...
### Marco de trabajo (CRO de paywall/upgrade)

**Objetivo:** paywalls, upgrades y gates de features.

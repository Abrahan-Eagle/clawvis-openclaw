---
name: revops
description: "RevOps: etapas lead→cliente, scoring, routing marketing→ventas. EN: RevOps, lead routing"
metadata:
  version: "1.1.0"
...
RevOps: etapas lead→cliente, scoring, routing marketing→ventas.

### Cuándo usarla (disparadores)

- **ES:** `pipeline CRM`, `routing leads`, `SLA`
- **EN:** `RevOps`, `lead routing`
...
- [`sales-enablement`](../sales-enablement/SKILL.md)

...
description: "Planes de envío a directorios (startup/SaaS) con alcance y riesgos. EN: directory submissions, listings"
metadata:
  version: "1.0.0"
...
Planes de envío a directorios (startup/SaaS) con alcance y riesgos.

### Cuándo usarla (disparadores)

- **ES:** `directorios`, `Product Hunt`, `listados`
- **EN:** `directory submissions`, `listings`

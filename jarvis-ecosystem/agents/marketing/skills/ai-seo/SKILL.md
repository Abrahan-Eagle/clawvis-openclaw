---
name: ai-seo
description: "Optimiza para motores de respuesta por IA y visibilidad en respuestas generadas. EN: AI SEO, AEO, GEO"
metadata:
  version: "1.2.0"
...
Optimiza para motores de respuesta por IA y visibilidad en respuestas generadas.

### Cuándo usarla (disparadores)

- **ES:** `ChatGPT`, `Perplexity`, `visibilidad IA`
- **EN:** `AI SEO`, `AEO`, `GEO`
...
### Marco de trabajo (SEO para respuestas IA (AEO/GEO/LLMO))

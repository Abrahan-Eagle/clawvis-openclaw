...
description: "SEO programático con plantillas + datos estructurados y control de calidad. EN: programmatic SEO, pSEO"
metadata:
  version: "1.1.0"
...
SEO programático con plantillas + datos estructurados y control de calidad.

### Cuándo usarla (disparadores)

- **ES:** `pSEO`, `plantillas SEO`, `datasets`
- **EN:** `programmatic SEO`, `pSEO`
...
### Marco de trabajo (SEO programático a escala)

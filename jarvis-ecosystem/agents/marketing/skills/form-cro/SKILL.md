---
name: form-cro
description: "Optimiza formularios (lead, contacto, demo): campos, errores y microcopy. EN: lead form, contact form"
metadata:
  version: "1.1.0"
...
Optimiza formularios (lead, contacto, demo): campos, errores y microcopy.

### Cuándo usarla (disparadores)

- **ES:** `formulario`, `lead form`, `demo request`
- **EN:** `lead form`, `contact form`
...
### Marco de trabajo (CRO de formularios)

**Objetivo:** formularios de lead/contacto/demo sin ser signup.

...
- **Carruseles Instagram y disenos:** skill [`carousel-ops`](../jarvis/skills/carousel-ops/SKILL.md) — guion, dimensiones, caption, **brief y checklist de calidad** (handoff Canva); **pipeline automatico** Canva via Composio hasta export si las herramientas estan activas. **AG-03** solo al **publicar** en la red, no al generar borrador/export. **open-carrusel** (`~/tools/`) opcional local. Detalle: [../../docs/CAROUSEL_IG_JARVIS.md](../../docs/CAROUSEL_IG_JARVIS.md) y [RECURSOS §2.9-2.10](../../docs/RECURSOS_COMUNIDAD_OPENCLAW.md).

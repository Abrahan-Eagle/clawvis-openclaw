...
- **Carruseles Instagram:** skill [`carousel-ops`](../jarvis/skills/carousel-ops/SKILL.md) (guion, dimensiones, caption; AG-03 antes de publicar). La app [open-carrusel](https://github.com/Hainrixz/open-carrusel) es **opcional** y fuera del monorepo — [../../docs/CAROUSEL_IG_JARVIS.md](../../docs/CAROUSEL_IG_JARVIS.md).

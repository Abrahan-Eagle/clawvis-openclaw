...
| 3 | Trello por empresa | [CONVENCION_TRELLO_EMPRESA_CLIENTE.md](CONVENCION_TRELLO_EMPRESA_CLIENTE.md), MEMORY.md (tabla Trello) |
| 4 | Discord | [DISCORD_ESTRUCTURA_CHECKLIST.md](DISCORD_ESTRUCTURA_CHECKLIST.md), [PLANTILLA_DISCORD_TELEGRAM_EMPRESA.md](PLANTILLA_DISCORD_TELEGRAM_EMPRESA.md) |
| 5 | Reporte supervisor → CEO | [SUPERVISOR_CEO_REPORTE.md](SUPERVISOR_CEO_REPORTE.md) |

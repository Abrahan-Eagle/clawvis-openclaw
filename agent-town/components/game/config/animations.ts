...
export const WORKER_SPRITES: WorkerSpriteConfig[] = [
  ...
  // Jarvis ecosystem — extra seats (keys únicos; se reutilizan sheets existentes)
  { key: "character_01", path: "/characters/Premade_Character_48x48_01.png", label: "Jarvis" },
  { key: "character_06", path: "/characters/Premade_Character_48x48_06.png", label: "Marketing 1" },
  { key: "worker_mkt2", path: "/characters/Premade_Character_48x48_03.png", label: "Marketing 2" },
  { key: "worker_sales1", path: "/characters/Premade_Character_48x48_04.png", label: "Sales 1" },
  { key: "worker_sales2", path: "/characters/Premade_Character_48x48_05.png", label: "Sales 2" },
];
